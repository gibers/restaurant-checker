...
docker build --build-arg JAR_FILE=restaurant-checker-0.0.1-SNAPSHOT.jar -f DockerSource/Dockerfile-old -t resto-i3 .
...
docker build --build-arg JAR_FILE=restaurant-checker-0.0.1-SNAPSHOT.jar -f Dockerfile-optimized -t resto-i3 .
